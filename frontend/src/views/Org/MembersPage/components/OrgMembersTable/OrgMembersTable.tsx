  ...
  return (
    <div className="w-full">
        ...
        <ModalContent
          ...
          subTitle={
            <div>
              ...
              {completeInviteLink &&
                "This Gsoc2 instance does not have a email provider setup. Please share this invite link with the invitee manually"}
            </div>
          }
        >
          {!completeInviteLink && (
      ...
      <UpgradePlanModal
        ...
        text="You can add custom environments if you switch to Gsoc2's Team plan."
      />
      <EmailServiceSetupModal
