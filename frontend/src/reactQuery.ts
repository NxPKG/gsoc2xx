...
export const SIGNUP_TEMP_TOKEN_CACHE_KEY = ["gsoc2__signup-temp-token"];
export const MFA_TEMP_TOKEN_CACHE_KEY = ["gsoc2__mfa-temp-token"];
export const AUTH_TOKEN_CACHE_KEY = ["gsoc2__auth-token"];
