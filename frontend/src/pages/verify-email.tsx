  ...
  return (
    <div className="flex h-screen flex-col justify-start bg-bunker-800 px-6">
      <Head>
        ...
        <meta property="og:title" content="Verify your email in Gsoc2" />
        <meta
          name="og:description"
          content="Gsoc2 a simple end-to-end encrypted platform that enables teams to sync and manage their .env files."
        />
      </Head>
      <Link href="/">
