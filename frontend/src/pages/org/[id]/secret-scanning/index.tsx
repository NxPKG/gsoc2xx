...
const SecretScanning = withPermission(
  () => {
    ...
    const generateNewIntegrationSession = async () => {
      ...
      router.push(
        `https://github.com/apps/gsoc2-radar/installations/new?state=${session.sessionId}`
      );
    };
                ...
                <div>
                  {integrationEnabled ? (
                    <p className="text-mineshaft-300">
                      Your GitHub organization is connected to Gsoc2, and is being continuously
                      monitored for secret leaks.
                    </p>
                  ) : (
                    <p className="text-mineshaft-300">
                      Connect your GitHub organization to Gsoc2.
                    </p>
                  )}
                </div>
              </div>
