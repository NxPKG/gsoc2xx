    ...
    >
      ...
      >
        ...
        <a
          ...
          href="https://gsoc2.com/docs/cli/overview"
        >
      ...
      >
        <CodeItem
          ...
          code="brew install gsoc2/get-cli/gsoc2"
          id="downloadCode"
        />
        <CodeItem
        ...
        <CodeItem
          ...
          code="gsoc2 run -- [YOUR USUAL CODE START SCRIPT GOES HERE]"
          id="runCode"
        />
        <p className="text-bunker-300 text-sm mt-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            href="https://gsoc2.com/docs/integrations/overview"
          >
            here
          </a>
          .{" "}
      ...
      <Tabs.Content className="grow p-5 pt-0 bg-bunker-700 rounded-b-md outline-none" value="tab2">
        <CodeItem
          ...
          setIsCopied={setDownloadCodeCopied}
          textExplanation="1. Download CLI"
          code="scoop bucket add org https://github.com/Gsoc2/scoop-gsoc2.git"
          id="downloadCodeW"
        />
        ...
        {!serverDetails?.redisConfigured && (
          <div className="mb-4 flex flex-col items-start justify-start px-6 py-6 pb-0 text-3xl">
            ...
            <div className="w-full border border-blue-400/70 rounded-md bg-blue-900/70 p-2 text-base text-mineshaft-100 flex items-center">
              ...
              />
              Attention: Updated versions of Gsoc2 now require Redis for full functionality.
              Learn how to configure it
              <Link
                href="https://gsoc2.com/docs/self-hosting/configuration/redis"
                target="_blank"
              >
        ...
        {!(
          ...
          <div className="mb-4 flex flex-col items-start justify-start px-6 py-6 pb-0 text-3xl">
            ...
            <div className="mb-3 grid w-full grid-cols-1 gap-3 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
              <LearningItemSquare
                text="Watch Gsoc2 demo"
                subText="Set up Gsoc2 in 3 min."
              ...
              {orgWorkspaces.length !== 0 && (
                <>
                  ...
                  <LearningItemSquare
                    ...
                    subText="Gsoc2 is better used as a team."
                    complete={usersInOrg}
                    icon={faUserPlus}
                    time="2 min"
            ...
            {orgWorkspaces.length !== 0 && (
              <LearningItem
                text="Integrate Gsoc2 with your infrastructure"
                subText="Connect Gsoc2 to various 3rd party services and platforms."
                complete={false}
                icon={faPlug}
                time="15 min"
                link="https://gsoc2.com/docs/integrations/overview"
              />
            )}
          </div>
        )}
              ...
              >
                ...
                <div className="flex w-full items-center">
                  ...
                  <a
                    ...
                    href="https://gsoc2.com/docs/documentation/getting-started/kubernetes"
                  >
                    Learn more{" "}
                    <FontAwesomeIcon
                      icon={faArrowRight}
