    ...
    >
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        ...
        <CardTitle 
          ...
          subTitle="Select which environment or folder in Gsoc2 you want to sync to GCP Secret Manager."
        >
          <div className="flex flex-row items-center">
            ...
            <Link href="https://gsoc2.com/docs/integrations/cloud/gcp-secret-manager" passHref>
