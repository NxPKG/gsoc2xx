    ...
    <div className="flex h-full w-full items-center justify-center">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600 mb-12">
        <CardTitle 
          ...
          subTitle="Choose which environment or folders in Gsoc2 you want to sync to which project in TeamCity."
        >
          <div className="flex flex-row items-center">
            ...
            <Link href="https://gsoc2.com/docs/integrations/cloud/teamcity" passHref>
