    ...
    return integrationAuth &&
        ...
        <div className="flex h-full w-full items-center justify-center bg-gradient-to-tr from-mineshaft-900 to-bunker-900">
            <Card className="max-w-lg rounded-md p-0 border border-mineshaft-600">
                <CardTitle className="text-left px-6" subTitle="Choose which environment in Gsoc2 you want to sync with your Cloudflare Workers project.">Cloudflare Workers Integration</CardTitle>
                <FormControl label="Gsoc2 Project Environment" className="mt-2 px-6">
                    <Select
