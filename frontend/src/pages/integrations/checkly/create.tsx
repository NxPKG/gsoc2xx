...
export default function ChecklyCreateIntegrationPage() {
  ...
  return integrationAuth &&
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600 p-0">
        ...
        >
          <div className="flex flex-row items-center">
            ...
            <Link href="https://gsoc2.com/docs/integrations/cloud/checkly" passHref>
    ...
    <div className="flex justify-center items-center w-full h-full">
      ...
      {isIntegrationAuthAppsLoading || isintegrationAuthGroupsLoading ? <img src="/images/loading/loading.gif" height={70} width={120} alt="gsoc2 loading indicator" /> : <div className="max-w-md h-max p-6 border border-mineshaft-600 rounded-md bg-mineshaft-800 text-mineshaft-200 flex flex-col text-center">
