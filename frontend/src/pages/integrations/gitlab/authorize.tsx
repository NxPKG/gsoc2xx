    ...
    <div className="flex h-full w-full items-center justify-center">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600 mb-12">
        <CardTitle 
          ...
          subTitle="Authorize this integration to sync secrets from Gsoc2 to GitLab. If no self-hosted GitLab URL is specified, then Gsoc2 will connect you to GitLab Cloud."
        >
