...
export default function QoveryCreateIntegrationPage() {
  ...
  return integrationAuth &&
    ...
    <div className="flex flex-col h-full w-full items-center justify-center bg-gradient-to-tr from-mineshaft-900 to-bunker-900">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600 p-0">
        <CardTitle 
          ...
          subTitle="Choose which environment in Gsoc2 you want to sync to Checkly environment variables."
        >
          <div className="flex flex-row items-center">
            ...
            <Link href="https://gsoc2.com/docs/integrations/cloud/qovery" passHref>
        ...
        <Tabs defaultValue={TabSections.Gsoc2Settings} className="px-6">
          <TabList>
            <div className="flex flex-row border-b border-mineshaft-600 w-full">
              <Tab value={TabSections.Gsoc2Settings}>Gsoc2 Settings</Tab>
              <Tab value={TabSections.QoverySettings}>Qovery Settings</Tab>
            </div>
          </TabList>
          <TabPanel value={TabSections.Gsoc2Settings}>
            <motion.div
              key="panel-1"
            ...
            >
              <FormControl label="Gsoc2 Project Environment">
                <Select
      ...
      <div className="flex flex-col bg-mineshaft-800 border border-mineshaft-600 w-full p-4 max-w-lg mt-6 rounded-md">
        ...
        <span className="text-mineshaft-300 text-sm mt-4">After creating an integration, your secrets will start syncing immediately. This might cause an unexpected override of current secrets in Qovery with secrets from Gsoc2.</span>
      </div> */}
    </div>
  ) : (
    <div className="flex justify-center items-center w-full h-full">
      ...
      {isIntegrationAuthAppsLoading ? <img src="/images/loading/loading.gif" height={70} width={120} alt="gsoc2 loading indicator" /> : <div className="max-w-md h-max p-6 border border-mineshaft-600 rounded-md bg-mineshaft-800 text-mineshaft-200 flex flex-col text-center">
