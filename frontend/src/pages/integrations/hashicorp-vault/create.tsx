    ...
    <div className="flex flex-col h-full w-full items-center justify-center">
      ...
      <Card className="max-w-lg rounded-md border border-mineshaft-600">
        <CardTitle 
          ...
          subTitle="Select which environment or folder in Gsoc2 you want to sync to which path in HashiCorp Vault."
        >
          <div className="flex flex-row items-center">
            ...
            <Link href="https://gsoc2.com/docs/integrations/cloud/hashicorp-vault" passHref>
      ...
      <div className="flex flex-col bg-mineshaft-800 border border-mineshaft-600 w-full p-4 max-w-lg mt-6 rounded-md">
        ...
        <span className="text-mineshaft-300 text-sm mt-4">After creating an integration, your secrets will start syncing immediately. This might cause an unexpected override of current secrets in Vault with secrets from Gsoc2.</span>
      </div>
    </div>
  ) : (
