...
const supportOptions = (t: TFunction) => [
  ...
  [
    ...
    t("nav.support.issue"),
    "https://github.com/Gsoc2/gsoc2-cli/issues"
  ],
  [
    ...
    <div className="z-[70] border-b border-mineshaft-500 bg-mineshaft-900 text-white">
      ...
      {subscription && subscription.slug === "starter" && !subscription.has_used_trial && (
        <div className="w-full mx-auto border-t border-mineshaft-500 text-center">
          ...
          >
              You are currently on the <span className="font-semibold">Starter</span> plan. Unlock the full power of Gsoc2 on the <span className="font-semibold">Pro Free Trial &rarr;</span>
          </button>
        </div>
      )}
    </div>
