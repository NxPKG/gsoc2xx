...
export const AdminLayout = ({ children }: LayoutProps) => {
  ...
  const gsoc2PlatformVersion = process.env.NEXT_PUBLIC_GSOC2_PLATFORM_VERSION;
                  ...
                  <div className="flex h-12 cursor-default justify-between items-center px-3 pt-6">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="start" className="p-1">
                        ...
                        <a
                          href="https://gsoc2.com/docs/documentation/getting-started/introduction"
                          target="_blank"
              ...
              >
                ...
                >
                  ...
                  <div className="mt-2 h-[6.77rem] w-full rounded-md border border-mineshaft-700">
                    <Image
                      src="/images/gsoc2-update-september-2023.png"
                      height={319}
                      width={539}
                  ...
                  <div className="mt-3 flex w-full items-center justify-between px-0.5">
                    ...
                    <a
                      href="https://gsoc2.com/blog/gsoc2-update-september-2023"
                      target="_blank"
                      rel="noopener noreferrer"
                ...
                {gsoc2PlatformVersion && (
                  <div className="mb-2 w-full pl-5 duration-200 hover:text-mineshaft-200">
                    <FontAwesomeIcon icon={faInfo} className="mr-4 px-[0.1rem]" />
                    Version: {gsoc2PlatformVersion}
                  </div>
                )}
              </div>
            </nav>
