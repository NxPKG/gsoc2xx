...
var initCmd = &cobra.Command{
	Use:                   "init",
	Short:                 "Used to connect your local project with Gsoc2 project",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if len(workspaces) == 0 {
			message := fmt.Sprintf("You don't have any projects created in Gsoc2. You must first create a project at %s", util.GSOC2_TOKEN_NAME)
		...
		prompt := promptui.Select{
			Label: "Which of your Gsoc2 projects would you like to connect this project to?",
...
func writeWorkspaceFile(selectedWorkspace models.Workspace) error {
	...
	err = util.WriteToFile(util.GSOC2_WORKSPACE_CONFIG_FILE_NAME, marshalledWorkspaceFile, 0600)
	if err != nil {
		return err
	}
