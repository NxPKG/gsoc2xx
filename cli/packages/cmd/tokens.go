...
var tokensCreateCmd = &cobra.Command{
	...
	DisableFlagsInUseLine: true,
	Example:               "gsoc2 service-token create",
	Args:                  cobra.ExactArgs(0),
	PreRun: func(cmd *cobra.Command, args []string) {
		util.RequireLogin()
	},
	Run: func(cmd *cobra.Command, args []string) {
		...
		if workspaceId == "" {
			...
			if err != nil {
				util.PrintErrorMessageAndExit("Please either run gsoc2 init to connect to a project or pass in project id with --projectId flag")
			}
...
func init() {
	tokensCreateCmd.Flags().String("projectId", "", "The project ID you'd like to create the service token for. Default: will use linked Gsoc2 project in .gsoc2.json")
