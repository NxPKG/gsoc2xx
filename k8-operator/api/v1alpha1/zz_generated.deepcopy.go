...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Gsoc2Secret) DeepCopyInto(out *Gsoc2Secret) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Gsoc2Secret.
func (in *Gsoc2Secret) DeepCopy() *Gsoc2Secret {
	if in == nil {
		return nil
	}
	out := new(Gsoc2Secret)
...
func (in *Gsoc2Secret) DeepCopyObject() runtime.Object {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Gsoc2SecretList) DeepCopyInto(out *Gsoc2SecretList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]Gsoc2Secret, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Gsoc2SecretList.
func (in *Gsoc2SecretList) DeepCopy() *Gsoc2SecretList {
	if in == nil {
		return nil
	}
	out := new(Gsoc2SecretList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *Gsoc2SecretList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Gsoc2SecretSpec) DeepCopyInto(out *Gsoc2SecretSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Gsoc2SecretSpec.
func (in *Gsoc2SecretSpec) DeepCopy() *Gsoc2SecretSpec {
	if in == nil {
		return nil
	}
	out := new(Gsoc2SecretSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Gsoc2SecretStatus) DeepCopyInto(out *Gsoc2SecretStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Gsoc2SecretStatus.
func (in *Gsoc2SecretStatus) DeepCopy() *Gsoc2SecretStatus {
	if in == nil {
		return nil
	}
	out := new(Gsoc2SecretStatus)
	in.DeepCopyInto(out)
	return out
}
