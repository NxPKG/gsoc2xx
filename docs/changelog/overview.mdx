...
- Released [secret rotation](https://gsoc2.com/docs/documentation/platform/secret-rotation/overview) feature with preliminary support for rotating [SendGrid](https://gsoc2.com/docs/documentation/platform/secret-rotation/sendgrid), [PostgreSQL/CockroachDB](https://gsoc2.com/docs/documentation/platform/secret-rotation/postgres), and [MySQL/MariaDB](https://gsoc2.com/docs/documentation/platform/secret-rotation/mysql) credentials.
- Released secret reminders feature.

## October 2023

- Added support for [GitLab SSO](https://gsoc2.com/docs/documentation/platform/sso/gitlab).
- Became SOC 2 (Type II) certified.
- Reduced required JWT configuration from 5-6 secrets to 1 secret for self-hosting Gsoc2.
- Compacted Gsoc2 into 1 Docker image.
- Added native [Hasura Cloud integration](https://gsoc2.com/docs/integrations/cloud/hasura-cloud).
- Updated resource deletion logic for user, organization, and project deletion.

## September 2023

- Released [secret approvals](https://gsoc2.com/docs/documentation/platform/pr-workflows) feature.
- Released an update to access controls; every user role now clearly defines and enforces a certain set of conditions across Gsoc2.
- Updated UI/UX for integrations. 
- Added a native integration with [Qovery](https://gsoc2.com/docs/integrations/cloud/qovery).
- Added service token generation capability for the CLI.

## August 2023

- Release Audit Logs V2.
- Add support for [GitHub SSO](https://gsoc2.com/docs/documentation/platform/sso/github).
...
- Added native [GCP Secret Manager integration](https://gsoc2.com/docs/integrations/cloud/gcp-secret-manager)

## July 2023

- Released [secret referencing and importing](https://gsoc2.com/docs/documentation/platform/secret-reference) across folders and environments.
...
- Added native [Laravel Forge integration](https://gsoc2.com/docs/integrations/cloud/laravel-forge).
- Added native [Codefresh integration](https://gsoc2.com/docs/integrations/cicd/codefresh).
- Added native [Bitbucket integration](https://gsoc2.com/docs/integrations/cicd/bitbucket).
- Added native [DigitalOcean App Platform integration](https://gsoc2.com/docs/integrations/cloud/digital-ocean-app-platform).
- Added native [Cloud66 integration](https://gsoc2.com/docs/integrations/cloud/cloud-66).
- Added native [Terraform Cloud integration](https://gsoc2.com/docs/integrations/cloud/terraform-cloud).
- Added native [Northflank integration](https://gsoc2.com/docs/integrations/cloud/northflank).
- Added native [Windmill integration](https://gsoc2.com/docs/integrations/cloud/windmill).
- Added support for [Google SSO](https://gsoc2.com/docs/documentation/platform/sso/google)
- Added support for [Okta](https://gsoc2.com/docs/documentation/platform/sso/okta), [Azure AD](https://gsoc2.com/docs/documentation/platform/sso/azure), and [JumpCloud](https://gsoc2.com/docs/documentation/platform/sso/jumpcloud) [SAML](https://gsoc2.com/docs/documentation/platform/saml) authentication.
- Released [folders / path-based secret storage](https://gsoc2.com/docs/documentation/platform/folder).
- Released [webhooks](https://gsoc2.com/docs/documentation/platform/webhooks).

## June 2023

- Released the [Terraform Provider](https://gsoc2.com/docs/integrations/frameworks/terraform#5-run-terraform).
- Updated the usage and billing page. Added the free trial for the professional tier.
- Added native integrations with [Checkly](https://gsoc2.com/docs/integrations/cloud/checkly), [Hashicorp Vault](https://gsoc2.com/docs/integrations/cloud/hashicorp-vault), and [Cloudflare Pages](https://gsoc2.com/docs/integrations/cloud/cloudflare-pages).
...
- Released customer / license service to manage customer billing information, cloud plans, and self-hosted enterprise licenses; all instances of Gsoc2s now fetch/relay information from this service.
...
- Gsoc2 is open sourced.
- Added Gsoc2 CLI support for Docker and Docker Compose.
- Rewrote the Gsoc2 CLI in Golang to be platform-agnostic.
...
- Released first native integration between Gsoc2 and Heroku; environment variables can now be sent and kept in sync with Heroku.
...
- Released first version of the Gsoc2 platform with push/pull capability and end-to-end encryption.
