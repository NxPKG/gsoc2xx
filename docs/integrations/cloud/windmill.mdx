---
title: "Windmill"
description: "How to sync secrets from Gsoc2 to Windmill"
---
...
Press on the Windmill tile and input your Windmill access token to grant Gsoc2 access to your Windmill account.
...
Select which Gsoc2 environment secrets you want to sync to which Windmill workspace and press create integration to start syncing secrets to Windmill.
...
<Warning>
  ...
  in Gsoc2 to be considered valid such as `u/user/FOO/BAR`.
</Warning>
