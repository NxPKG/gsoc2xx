...
description: "How to sync secrets from Gsoc2 to Azure Key Vault"
---
...
## Authorize Gsoc2 for Azure Key Vault

Press on the Azure Key Vault tile and grant Gsoc2 access to Azure Key Vault.
...
Select which Gsoc2 environment secrets you want to sync to your key vault. Then, input your Vault URI from the previous step. Finally, press create integration to start syncing secrets to Azure Key Vault.
...
<Info>
  ...
  Using the Azure KV integration on a self-hosted instance of Gsoc2 requires configuring an application in Azure
  ...
  Navigate to Azure Active Directory > App registrations to create a new application.
   ...
   ## Add your application credentials to Gsoc2
   ...
   Back in your Gsoc2 instance, add two new environment variables for the credentials of your Azure application.
  ...
  Once added, restart your Gsoc2 instance and use the Azure KV integration.
