---
title: "Render"
description: "How to sync secrets from Gsoc2 to Render"
---
...
Press on the Render tile and input your Render API Key to grant Gsoc2 access to your Render account.
...
Select which Gsoc2 environment secrets you want to sync to which Render service and press create integration to start syncing secrets to Render.
