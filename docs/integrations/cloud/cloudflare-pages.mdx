...
description: "How to sync secrets from Gsoc2 to Cloudflare Pages"
---
...
## Authorize Gsoc2 for Cloudflare Pages
...
Press on the Cloudflare Pages tile and input your Cloudflare API token and account ID to grant Gsoc2 access to your Cloudflare Pages.
...
Select which Gsoc2 environment secrets you want to sync to Cloudflare and press create integration to start syncing secrets.
