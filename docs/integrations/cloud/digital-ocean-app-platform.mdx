...
description: "How to sync secrets from Gsoc2 to Digital Ocean App Platform"
---
...
Name it **gsoc2**, choose **No expiry**, and make sure to check **Write (optional)**. Then click on "Generate Token" and copy your API token.
![integrations digital ocean token modal](../../images/integrations/digital-ocean/integrations-do-token-modal.png)

## Navigate to your project's integrations tab

Click on the **Digital Ocean App Platform** tile and enter your API token to grant Gsoc2 access to your Digital Ocean account.
...
![integrations gsoc2 dashboard digital ocean integration](../../images/integrations/digital-ocean/integrations-do-enter-token.png)

## Start integration

Select which Gsoc2 environment secrets you want to sync to which Digital Ocean App and click "Create Integration".
