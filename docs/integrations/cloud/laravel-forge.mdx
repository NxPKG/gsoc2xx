---
title: "Laravel Forge"
description: "How to sync secrets from Gsoc2 to Laravel Forge"
---
...
Press on the Laravel Forge tile and input your Laravel Forge access token and server ID to grant Gsoc2 access to your Laravel Forge account.
...
Select which Gsoc2 environment secrets you want to sync to which Laravel Forge site and press create integration to start syncing secrets to Laravel Forge.
