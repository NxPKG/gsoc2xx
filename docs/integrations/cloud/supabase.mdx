---
title: "Supabase"
description: "How to sync secrets from Gsoc2 to Supabase"
---
...
Press on the Supabase tile and input your Supabase Access Token to grant Gsoc2 access to your Supabase account.
...
Select which Gsoc2 environment secrets you want to sync to which Supabase project. Lastly, press create integration to start syncing secrets to Supabase.
