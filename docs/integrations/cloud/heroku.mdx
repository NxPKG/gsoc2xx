---
title: "Heroku"
description: "How to sync secrets from Gsoc2 to Heroku"
---
...
## Authorize Gsoc2 for Heroku

Press on the Heroku tile and grant Gsoc2 access to your Heroku account.
...
Select which Gsoc2 environment secrets you want to sync to which Heroku app and press create integration to start syncing secrets to Heroku.
...
![integrations heroku](../../images/integrations/heroku/integrations-heroku.png)
  ...
  Using the Heroku integration on a self-hosted instance of Gsoc2 requires configuring an API client in Heroku
  ...
  Navigate to your user Account settings > Applications to create a new API client.
   ...
   ## Add your Heroku API client credentials to Gsoc2
   ...
   Back in your Gsoc2 instance, add two new environment variables for the credentials of your Heroku API client.

   - `CLIENT_ID_HEROKU`: The **Client ID** of your Heroku API client.
   - `CLIENT_SECRET_HEROKU`: The **Client Secret** of your Heroku API client.
   
  Once added, restart your Gsoc2 instance and use the Heroku integration.
