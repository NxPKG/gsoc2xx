...
Each project in Gsoc2 can have **End-to-End Encryption (E2EE)** enabled or disabled.
...
- You cannot make HTTP calls to Gsoc2 to read/write secrets in plaintext.
...
<AccordionGroup>
  <Accordion title="Should I have E2EE enabled or disabled?">
    ...
    - You're self-hosting Gsoc2, so having your instance of Gsoc2 be able to read your secrets isn't an issue.
    - You want an easier way to read/write secrets with Gsoc2.
  ...
  <Accordion title="How can I enable/disable E2EE?">
    You can enable/disable E2EE for your project in Gsoc2 in the Project Settings.
  </Accordion>
  <Accordion title="Is disabling E2EE secure?">
    ...
    If you're concerned about Gsoc2 Cloud's ability to read your secrets, then you may wish to
    use it with **E2EE** enabled or self-host Gsoc2 on your own infrastructure and disable E2EE there.
