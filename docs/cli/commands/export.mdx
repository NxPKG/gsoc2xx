---
title: "gsoc2 export"
description: "Export Gsoc2 secrets from CLI into different file formats"
---

```bash
gsoc2 export [options]
```
...
<Accordion title="gsoc2 export" defaultOpen="true">
  ...
  gsoc2 export --format=dotenv-export > .env

  # Export variables to a CSV file
  gsoc2 export --format=csv > secrets.csv

  # Export variables to a JSON file
  gsoc2 export --format=json > secrets.json

  # Export variables to a YAML file
  gsoc2 export --format=yaml > secrets.yaml
  ```
  ...
  <Accordion title="--projectId">
    By default the project id is retrieved from the `.gsoc2.json` located at the root of your local project. 
    This flag allows you to override this behavior by explicitly defining the project to fetch your secrets from.

    ```bash
    # Example 
    
    gsoc2 export --projectId=XXXXXXXXXXXXXX
    ```
  </Accordion>
  ...
  <Accordion title="--path">
    ...
    ```bash
    # Example
    gsoc2 export --path="/path/to/folder" --env=dev
    ```
  </Accordion>
