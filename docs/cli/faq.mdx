---
title: "FAQ"
description: "Frequently Asked Questions about Gsoc2 CLI"
---
...
If none of the available stores work for you, you can try using the `file` store type by running `gsoc2 vault set file`, which should work in most cases. 
If you are still experiencing trouble, please seek support. 

[Learn more about vault command](./commands/vault)
</Accordion>

<Accordion title="Can I fetch secrets with Gsoc2 if I am offline?">
...
<Accordion title="Can I upload the .gsoc2.json file that was generated?">
