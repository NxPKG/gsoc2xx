...
From local development to production, Gsoc2 SDKs provide the easiest way for your app to fetch back secrets from Gsoc2 on demand. 

- Install and initialize a language-specific client SDK into your application
- Provision the client scoped-access to a project and environment in Gsoc2
- Fetch secrets on demand

<CardGroup cols={2}>
  <Card
    title="Node"
    href="https://github.com/Gsoc2/gsoc2-node"
    icon="node"
    color="#68a063"
  >
  ...
  <Card 
    href="https://github.com/Gsoc2/gsoc2-python" 
    title="Python" 
    icon="python" 
    color="#4c8abe"
    >
...
<AccordionGroup>
    ...
    <Accordion title="What's the point if I still have to manage a token for the SDK?">
        ...
        - You always pull in the right secrets because they're fetched on demand from a centralize source that is Gsoc2.
