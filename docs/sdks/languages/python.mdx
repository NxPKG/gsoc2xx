...
If you're working with Python, the official [gsoc2-python](https://github.com/Gsoc2/gsoc2-python) package is the easiest way to fetch and work with secrets for your application.
...
Run `pip` to add `gsoc2-python` to your project
...
Follow this GitHub
[issue](https://github.com/Gsoc2/gsoc2/issues/433) to stay updated.
