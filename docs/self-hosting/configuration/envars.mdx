...
description: "Configure your environment variables when self-hosting Gsoc2."
---
...
<ParamField query="REDIS_URL" type="string" default="none" required>
  ...
  <Tab title="Email service">
    <Info>When email service is not configured, Gsoc2 will have limited functionality</Info>
    ...
    <ParamField query="SMTP_USERNAME" type="string" default="none" optional>
      Credential to connect to host (e.g. team@gsoc2.com)
    </ParamField>
...
Gsoc2 uses Sentry to report error logs
...
<ParamField query="INVITE_ONLY_SIGNUP" type="string" default="false" optional>
  ...
  <ParamField query="SITE_URL" type="string" default="none" optional>
    Site URL - should be an absolute URL including the protocol (e.g. https://app.gsoc2.com)
  </ParamField>
