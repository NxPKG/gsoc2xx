---
title: "AWS EC2"
description: "Learn to install Gsoc2 on EC2 using Cloud Formation template"
---
...
This deployment option will use AWS Cloudformation to auto deploy an instance of Gsoc2 on a single EC2 via Docker Compose.
...
<a href="https://us-east-1.console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/create/review?templateURL=https://ec2-instance-cloudformation.s3.amazonaws.com/gsoc2-ec2-deployment.template&stackName=gsoc2">
