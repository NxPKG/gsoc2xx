...
It uses an API key to do various operations. Using Gsoc2 you can easily dynamically change the keys.

## Working

1. Gsoc2 will need an admin token of SendGrid to create API keys dynamically.
2. Using the given admin token and scope by user Gsoc2 will create and rotate API keys periodically
3. Under the hood gsoc2 uses [SendGrid API](https://docs.sendgrid.com/api-reference/api-keys/create-api-keys)
