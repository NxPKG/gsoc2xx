...
Gsoc2 will update periodically the provided database user's password.

<Warning>
	At present Gsoc2 do require access to your database. We will soon be released Gsoc2 agent based rotation which would help you rotate without direct database access from Gsoc2 cloud.
</Warning>

## Working

1. User's has to create the two user's for Gsoc2 to rotate and provide them required database access
2. Gsoc2 will connect with your database with admin access
