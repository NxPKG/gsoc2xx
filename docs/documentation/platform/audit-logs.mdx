---
title: "Audit Logs"
description: "See which events are triggered within your Gsoc2 project."
---

<Info>
    Note that Audit Logs is a paid feature.

    If you're using Gsoc2 Cloud, then it is available under the **Team Tier**, **Pro Tier**,
    and **Enterprise Tier** with varying retention periods. If you're self-hosting Gsoc2,
    then you should contact team@gsoc2.com to purchase an enterprise license to use it.
</Info>

Gsoc2 provides audit logs for security and compliance teams to monitor information access.
