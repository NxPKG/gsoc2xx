---
title: "PR Workflows"
description: "Gsoc2 PR Workflows allows you to create a set of policies to control secret operations."
---
...
An approver is notified by email and/or Slack as soon as the request is initiated. In the Gsoc2 Dashboard, they will be able to `approve` and `merge` (or `deny`) a request for a change in a particular environment. After that, depending on the workflows setup, the change will be automatically propagated to the right applications (e.g., using [Gsoc2 Kubernetes Operator](https://gsoc2.com/docs/integrations/platforms/kubernetes)).
