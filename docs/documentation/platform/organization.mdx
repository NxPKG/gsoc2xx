---
title: "Organization"
description: "How Gsoc2 structures its organizations."
---
...
- SAML Authentication: The SAML SSO configuration of the organization (if applicable); Gsoc2 currently
...
<Info>
  ...
  Gsoc2 provides immutable roles like `admin`, `member`, etc.
  at the organization and project level for free.

  If you're using Gsoc2 Cloud, the ability to create custom roles is available under the **Pro Tier**. 
  If you're self-hosting Gsoc2, then you should contact team@gsoc2.com to purchase an enterprise license to use it.
</Info>

![organization roles](../../images/platform/organization/organization-members-roles.png)

As you can see next, Gsoc2 supports granular permissions that you can tailor to each role. So,
...
The **Usage & Billing** page applies only to [Gsoc2 Cloud](https://app.gsoc2.com) and is where you can
...
- Licenses: The license keys for self-hosted instances of Gsoc2 (if applicable).
