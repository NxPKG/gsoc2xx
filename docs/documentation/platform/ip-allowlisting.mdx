...
description: "Restrict access to your secrets in Gsoc2 using trusted IPs"
---
...
Projects in Gsoc2 can be configured to restrict client access to specific IP addresses or CIDR ranges. This applies to any client using service tokens and
