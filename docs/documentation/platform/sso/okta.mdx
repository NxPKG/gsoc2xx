---
title: "Okta SAML"
description: "Configure Okta SAML 2.0 for Gsoc2 SSO"
---
...
4. On the General Settings screen, give the application a unique name like Gsoc2 and select **Next**.
...
Copy the **Identity Provider Single Sign-On URL**, the **Identity Provider Issuer**, and the **X.509 Certificate** to use when finishing configuring Okta SAML in Gsoc2.

![SAML Okta IdP values](../../../images/sso/okta/idp-values.png)

Back in Gsoc2, set **Identity Provider Single Sign-On URL**, **Identity Provider Issuer**,
...
![SAML Okta paste values into Gsoc2](../../../images/sso/okta/idp-values-2.png)
...
9. Return to Gsoc2 and enable SAML SSO.

Enabling SAML SSO enforces all members in your organization to only be able to log into Gsoc2 via Okta.
