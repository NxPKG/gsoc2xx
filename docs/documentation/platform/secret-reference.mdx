...
description: "How to use reference secrets in Gsoc2"
---

## Secret Referencing

Gsoc2's secret referencing feature lets you reference the value of a "base" secret when defining the value of another secret.
...
<Note>
    ...
    [Gsoc2 CLI](/cli/overview) and [native integrations](/integrations/overview).

    We intend to add support for it to the [Node SDK](https://github.com/Gsoc2/gsoc2-node)
    and [Python SDK](https://github.com/Gsoc2/gsoc2-python) this quarter.
</Note>
...
Gsoc2's secret imports feature lets you import the items of another environment or folder into the current folder context.
