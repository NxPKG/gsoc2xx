...
Gsoc2 is an [open-source](https://opensource.com/resources/what-open-source), [end-to-end encrypted](https://en.wikipedia.org/wiki/End-to-end_encryption) secret management platform for storing, managing, and syncing
...
Start syncing environment variables with [Gsoc2 Cloud](https://app.gsoc2.com) or learn how to [host Gsoc2](/self-hosting/overview) yourself.
...
<Card
    ...
    color="#dc2626"
>
    Store secrets like API keys, database credentials, environment variables with Gsoc2
</Card>
...
<CardGroup cols={2}>
  <Card
    ...
    color="#0285c7"
  >
    Learn how to configure and deploy Gsoc2
  </Card>
  <Card
  ...
  <Card
    href="https://calendly.com/team-gsoc2/gsoc2-demo"
    title="Contact Us"
    icon="user-headset"
    color="#0285c7"
  >
