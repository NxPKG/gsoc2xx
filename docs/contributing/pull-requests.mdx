---
title: 'Pull requests'
description: 'This guide walks through the code submission process for Gsoc2.'
---
...
Once your PR is reviewed, one or two relevant members of the Gsoc2 team should review and approve the PR before it is merged. You should coordinate and ping the team member closest to the submitted functionality via our [Slack](https://gsoc2.com/slack) to review your PR.
