...
class Telemetry {
  ...
  static logTelemetryMessage = async () => {
    ...
    if(!(await getTelemetryEnabled())){
      [
        "To improve, Gsoc2 collects telemetry data about general usage.",
        "This helps us understand how the product is doing and guide our product development to create the best possible platform; it also helps us demonstrate growth as we support Gsoc2 as open-source software.",
