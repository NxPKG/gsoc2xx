...
/**
 * Generates OpenAPI specs for all Gsoc2 API endpoints:
...
const generateOpenAPISpec = async () => {
  const doc = {
    ...
    host: ["https://gsoc2.com"],
    servers: [
      {
        url: "https://app.gsoc2.com",
    ...
    securityDefinitions: {
      bearerAuth: {
        ...
        scheme: "bearer",
        bearerFormat: "JWT",
        description: "A service token in Gsoc2"
      },
      apiKeyAuth: {
        type: "apiKey",
        in: "header",
        name: "X-API-Key",
        description: "An API Key in Gsoc2"
      }
    },
    definitions: {
      CurrentUser: {
